...
class WeatherApp {
    ...
    updateBackground(weatherCondition, isDay) {
        ...
        // Map JS weather condition to CSS class for day
        const dayMap = {
            sunny: 'sunny',
            cloudy: 'cloudy',
            rainy: 'rainy',
        ...
        // Map JS weather condition to CSS class for night
        const nightMap = {
            sunny: 'night-clear',
            cloudy: 'night-cloudy',
            rainy: 'night-rainy',
        ...
        if (!isDay) {
            const nightClass = nightMap[weatherCondition] || 'night-cloudy';
            background.classList.add(nightClass);
        } else {
            const dayClass = dayMap[weatherCondition] || 'cloudy';
            background.classList.add(dayClass);
        }
    }
